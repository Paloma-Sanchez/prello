...
<template>
  ...
  >
    <div class="c-board-top-bar-left flex items-center">
      <div>
        <h3
        ...
        <UInput
          ...
          :ui="{
            variant: {
              outline: 'bg-sky-600/80 text-slate-200 ring-0 font-title text-lg',
            },
            base: 'w-3/4',
          }"
        />
      </div>
      <div class="cursor-pointer" @click="onStarredClick">
        <UButton
          v-if="board.starred"
          color="white"
          ...
          variant="link"
        />
        <UButton v-else color="white" icon="i-heroicons-star" size="xs" variant="link" />
      </div>
    </div>
    <div class="c-boar-top-bar-right flex pr-4">
      <UButton
        class="mr-2"
        color="sky"
        size="2xs"
