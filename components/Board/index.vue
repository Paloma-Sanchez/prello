...
const toggleBackgroundMenuVisible = () => {
  backgroundMenuActive.value = !backgroundMenuActive.value;
};

 defineExpose ({
     toggleBackgroundMenuVisible,
});
</script>
<template>
  <div
  ...
  >
    <main class="c-main-board board h-full" @click.self="onClickOnMain">
      <BoardColumn
      ...
      <BoardTopBarChangeBgMenu
        ...
        @closeChangeBgMenu="backgroundMenuActive = false"
      />
      <UContainer class="column mx-4 min-w-[256px] max-w-[256px]">
        <UInput
