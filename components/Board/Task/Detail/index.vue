...
const onSubmit = async () => {
  if (
    !(
      props.task.name === state.newTaskName &&
      props.task.description === state.newTaskDescription
    )
  ) {
...
<template>
  ...
  >
    <div
      ...
      :class="['c-cover', 'h-28', 'w-full', 'px-0', 'py-0', 'rounded-t-lg']"
    ...
    <div class="p-6 pt-4">
      ...
      <p class="text-sm mb-6 font-text text-gray-300">
        ...
        <span class="text-md"> {{ "   " + board.name }}</span>
      </p>
